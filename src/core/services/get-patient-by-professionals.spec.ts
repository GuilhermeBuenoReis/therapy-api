...
import { GetPatientByProfessionalsService } from './get-patient-by-professionals';

let sut: GetPatientByProfessionalsService;
let inMemoryPatientRepository: InMemoryPatientRepository;
let inMemoryProfessionalsRepository: InMemoryProfessionalsRepository;

describe('Get Patient By Professionals Service', () => {
  beforeEach(() => {
    inMemoryPatientRepository = new InMemoryPatientRepository();
    inMemoryProfessionalsRepository = new InMemoryProfessionalsRepository();

    sut = new GetPatientByProfessionalsService(
