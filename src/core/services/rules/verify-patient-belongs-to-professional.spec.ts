...
import { VerifyPatientBelongsToProfessional } from './verify-patient-belongs-to-professional';

let sut: VerifyPatientBelongsToProfessional;
let inMemoryPatientRepository: InMemoryPatientRepository;

describe('Verify Patient Belongs To Professional', () => {
  beforeEach(() => {
    inMemoryPatientRepository = new InMemoryPatientRepository();
    sut = new VerifyPatientBelongsToProfessional(inMemoryPatientRepository);
  });

  it('should confirm when patient belongs to professional', async () => {
